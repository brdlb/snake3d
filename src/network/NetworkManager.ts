...
export class NetworkManager {
  ...
  sendDirection(direction:{x:number;y:number;z:number}) { if(this.socket?.readyState===WebSocket.OPEN)this.socket.send(JSON.stringify({v:2,type:'player.input',payload:{action:{type:'direction',direction}}})); }
