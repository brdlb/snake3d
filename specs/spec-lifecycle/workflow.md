...
## Workflow Chain
After preparing or editing technical use cases and before consistency review, follow `~/.agents/skills/layered-spec-core/references/validation.md`. Apply its validation/repair completion rule, workflow.json preferences, installation approval and permitted skips, including when optional semantic review is skipped. This does not change implementation authorization.
